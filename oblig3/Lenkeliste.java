...
public class Lenkeliste <T> implements Liste<T>{
  ...
  public Iterator<T> iteratorForan(){
    return new MinIteratorForan();
  }

  public Iterator<T> iteratorSist(){
    return new MinIteratorSist();
  }

  private class MinIteratorForan implements Iterator<T>{
  ...
  private class MinIteratorSist implements Iterator<T>{
    Node nodeForrige = sist;

    public boolean hasNext(){
      return nodeForrige!=null;
    }

    public T next(){
      T returData = nodeForrige.data;
      nodeForrige = nodeForrige.forrige;
      return returData;
    }
  }
}
